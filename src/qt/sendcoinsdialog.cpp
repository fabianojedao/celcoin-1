    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter an CelCoin address (e.g. oRBkGBRp3i8Cj1q4yeDh5nxz8ACj4TaH7D)"));
#endif
...
void SendCoinsDialog::setBalance(qint64 balance, qint64 stake, qint64 unconfirmed, qint64 immature)
{
    Q_UNUSED(stake);
