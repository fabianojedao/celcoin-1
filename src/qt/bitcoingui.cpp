...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    spinnerFrame(0)
{
    setWindowTitle(tr("CelCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/celcoin"));
    setWindowIcon(QIcon(":icons/celcoin"));
#else
...
void BitcoinGUI::createActions(int nQtStyle) {
    ...
    sendCoinsAction->setToolTip(tr("Send coins to an CelCoin address"));
    ...
    toggleHideAction = new QAction(QIcon(":/icons/celcoin"), tr("&Show / Hide"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/celcoin"), tr("&About CelCoin"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/celcoin_testnet"));
            setWindowIcon(QIcon(":icons/celcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/celcoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("CelCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("CelCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the CelCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid CelCoin address or malformed URI parameters."));
    }
