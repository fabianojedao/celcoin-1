...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 0,     std::make_pair(hashGenesisBlock, 1534444838) )
	( 1000, std::make_pair(uint256("0xec1043430ecf23b0a77c688569f68efaf0faf32100bbcb1873426f0f810f8754"), 1534562054) )
	( 8000, std::make_pair(uint256("0x299c13b1c4eff10da810b6f353d7681716611de5274b4907695ce9ee1497293b"), 1535337162) )
	( 8130, std::make_pair(uint256("0xc9fbda659673a11f6515efe5949e2688352e2cdf4d856d58e0346e571978156b"), 1535349110) )
        ( 87085, std::make_pair(uint256("0x34caed0b7cd0e49ec0694d917b7d09a65baf78ea56fb734ac08c4c0cd4f34497"), 1540938753) )
    ;

    // TestNet has no checkpoints
    static MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, std::make_pair(hashGenesisBlockTestNet, 1534444838) )
        ;
