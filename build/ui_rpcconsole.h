...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "CelCoin - RPC Console", 0));
        label_9->setText(QApplication::translate("RPCConsole", "CelCoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the CelCoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the CelCoin-Qt help message to get a list with possible CelCoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
        ...
        label_17->setText(QApplication::translate("RPCConsole", "Transmitted:", 0));
        btnClearTrafficGraph->setText(QApplication::translate("RPCConsole", "&Clear", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_nettraffic), QApplication::translate("RPCConsole", "&Network activity", 0));
    } // retranslateUi
